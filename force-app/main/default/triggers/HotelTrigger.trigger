...
* -- -----------   ----------   -------      ---------------------------------------
*/
trigger HotelTrigger on Hotel__c (after delete, after insert, after undelete, after update, before delete, before insert, before update) {
    
    // This should be used in conjunction with the TriggerHandlerComprehensive.cls template
    // The origin of this pattern is http://www.embracingthecloud.com/2010/07/08/ASimpleTriggerTemplateForSalesforce.aspx
    if (!UtilsBypass.canbyPassTrigger('HotelTrigger')) {
        HotelHandler handler = new HotelHandler(Trigger.isExecuting, Trigger.size);
        ...
        if(Trigger.isInsert && Trigger.isBefore){
            ...
            if((!System.isFuture() && !System.isBatch())){
                HotelHandler.OnAfterInsertAsync(Trigger.newMap.keySet());
            }
            ...
            if((!System.isFuture() && !System.isBatch())){
                HotelHandler.OnAfterUpdateAsync(Trigger.newMap.keySet());
            }
            ...
            if((!System.isFuture() && !System.isBatch())){
                HotelHandler.OnAfterDeleteAsync(Trigger.oldMap.keySet());
            }
