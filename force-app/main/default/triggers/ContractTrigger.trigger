...
trigger ContractTrigger on Contract (after delete, after insert, after undelete, after update, before delete, before insert, before update) {
    ...
    if (!UtilsBypass.canbyPassTrigger('AccountTrigger')) {
        ContractHandler handler = new ContractHandler(Trigger.isExecuting, Trigger.size);
        ...
        if(Trigger.isInsert && Trigger.isBefore){
            ...
            if((!System.isFuture() && !System.isBatch())){
                ContractHandler.OnAfterInsertAsync(Trigger.newMap.keySet());
            }
            ...
            if((!System.isFuture() && !System.isBatch())){
                ContractHandler.OnAfterUpdateAsync(Trigger.newMap.keySet());
            }
            ...
            if((!System.isFuture() && !System.isBatch())){
                ContractHandler.OnAfterDeleteAsync(Trigger.oldMap.keySet());
            }
